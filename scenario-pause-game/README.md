...
#### **추가 학습 후 도전**
- [FromSoftware 게임 모딩](../scenario-fromsoftware-modding/) - 전문 도구 활용
- [PAK 모드 로더](../scenario-pak-loader/) - 모듈화 시스템
...
**다음 학습**: [FPS 제한 해제](../scenario-unlock-fps/)
