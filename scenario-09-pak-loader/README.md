...
이제 PAK 모딩의 고급 기법을 익혔으니, 다음 시나리오로 넘어가세요:

- **몬스터 대전**: [Scenario 10: 몬스터 대전 시스템 구현](../scenario-10-monster-battle/)

---

**이전 학습**: [Scenario 08: FromSoftware 게임 모딩](../scenario-08-fromsoftware-modding/) | **다음 학습**: [Scenario 10: 몬스터 대전 시스템 구현](../scenario-10-monster-battle/)